// The uNickorn system prompt - spec section 7, verbatim, plus the
// correction-style few-shot examples from section 8. This is the heart of
// the product. Do not water it down.
...
// Used once at the end of a session to turn the transcript into the
// tutor_sessions summary row (spec section 5) and any new memory for
// student_profile.
...
// Builds the "STUDENT CONTEXT" block (spec section 6) from the student row,
// their student_profile row, and the last 1-3 tutor_sessions summaries.
// Handles a brand-new student (no profile / no history) gracefully.
