...
// Reusable gate: must be called before any uNickorn session can start.
// Returns { allowed: true, student, usage } or
// { allowed: false, reason, action, student? } where action is a hint
// for the UI ('upgrade' -> subscribe/reactivate, 'topup' -> buy more usage).
