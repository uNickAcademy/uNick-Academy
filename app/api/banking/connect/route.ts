...
import { isGoCardlessConfigured, getAccessToken, createRequisition } from "@/lib/banking/gocardless"
...
export async function POST(req: Request) {
  ...
  const redirectUrl = `${origin}/api/banking/callback?entity=${entityId}`
