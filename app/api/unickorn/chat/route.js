...
// One turn of the conversation. Claude is stateless, so every call sends the
// full system prompt, a freshly-built student context block, and the
// running history (including this turn's new user message).
