...
// Starts a Stripe Checkout session for the uNickorn subscription, using the
// discounted price for existing uNick Academy students and the full price
// for everyone else.
export async function POST(request) {
  ...
  const checkoutSession = await stripe.checkout.sessions.create({
    ...
    success_url: `${origin}/talk-to-unickorn?checkout=success`,
    cancel_url: `${origin}/talk-to-unickorn?checkout=cancelled`,
