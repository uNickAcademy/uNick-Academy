...
export const activityOptions=[
  {value:'teenpreneurs',label:'Teenpreneurs, 13–18 lat',minAge:13,maxAge:18},{value:'creative_diy',label:'Creative DIY, 10–15 lat',minAge:10,maxAge:15},{value:'podcasts_audio_video',label:'Podcasts Audio-Video, 13–18 lat',minAge:13,maxAge:18},{value:'art_performance_9_13',label:'Art & Performance, 9–13 lat',minAge:9,maxAge:13},{value:'art_performance_13_18',label:'Art & Performance, 13–18 lat',minAge:13,maxAge:18},
] as const
