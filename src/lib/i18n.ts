...
const DICT: Dict = {
  ...
  // Saldo zajęć do odrobienia (propozycja/akceptacja terminu)
  makeup_balance_title: { pl: 'Saldo zajęć do odrobienia', en: 'Make-up lesson balance' },
  makeup_balance_hint: { pl: 'Kliknij, aby zaproponować lub przyjąć termin odrobienia', en: 'Click to propose or accept a make-up time' },
  makeup_propose_time: { pl: 'Zaproponuj termin', en: 'Propose a time' },
  makeup_propose_error: { pl: 'Nie udało się wysłać propozycji.', en: 'Failed to send the proposal.' },
  makeup_respond_error: { pl: 'Nie udało się zapisać odpowiedzi.', en: 'Failed to save the response.' },
  makeup_awaiting_teacher: { pl: 'Czekasz na akceptację nauczyciela', en: 'Awaiting teacher acceptance' },
  makeup_withdraw: { pl: 'Wycofaj', en: 'Withdraw' },
  makeup_teacher_proposes: { pl: 'Nauczyciel proponuje', en: 'Teacher proposes' },
  makeup_accept: { pl: 'Akceptuj', en: 'Accept' },
  makeup_decline: { pl: 'Odrzuć', en: 'Decline' },
