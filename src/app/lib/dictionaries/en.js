...
const en = {
  ...
  legal: {
    ...
    privacyPolicy: {
      ...
      thirdPartiesText: "We may share your data with: Supabase (authentication and database hosting), Stripe (payment processing), Anthropic (AI service provider for the uNickorn tutor — conversation data is processed to provide the AI service). All processors operate under appropriate data processing agreements in compliance with GDPR.",
      ...
      cookies: "Cookies",
      cookiesText: "We use essential cookies required for the website to function (session management, language preference). Analytics cookies are only set with your consent. You can manage your cookie preferences at any time via the cookie banner or your browser settings.",
