...
import { formatDate, formatPLN } from "@/lib/ufos/formatters"
  ...
  return (
    <div className="max-w-5xl mx-auto">
      <div className="flex items-center justify-between mb-8">
        ...
        <Link href="/ufos/dokumenty/nowy" className="btn-primary text-sm">
              ...
              {documents.map((d) => (
                <tr key={d.id} className="border-t border-[#E8EBF0] hover:bg-brand-muted/40">
                  <td className="py-3 px-6">
                    <Link href={`/ufos/dokumenty/${d.id}`} className="font-medium text-navy-500 hover:underline">
                      {d.title}
                    </Link>
                    {d.file_name && (
