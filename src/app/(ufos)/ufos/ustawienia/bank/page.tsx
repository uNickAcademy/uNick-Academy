...
import { formatDateTime } from "@/lib/ufos/formatters"
import { isGoCardlessConfigured } from "@/lib/ufos/banking/gocardless"
      ...
      {!configured ? (
        <div className="card border border-dashed border-brand-amber py-5">
          ...
          <p className="text-xs text-brand-subtle">
            W międzyczasie możesz korzystać z <Link href="/ufos/platnosci/import" className="text-navy-500 underline">importu wyciągu CSV</Link>.
          </p>
        </div>
      ) : (
