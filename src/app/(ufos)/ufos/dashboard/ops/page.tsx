...
export default async function OpsDashboardPage() {
  ...
  if (role === "owner_cfo") redirect("/ufos/dashboard/cfo")
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          {!debtors || debtors.length === 0 ? (
            ...
            <>
              ...
              <div className="px-5 py-3 border-t border-[#E8EBF0]">
                <Link href="/ufos/lekcje/zaleglosci" className="text-xs text-navy-500 hover:underline">
        ...
        <div className="card">
          ...
          <div className="grid grid-cols-2 gap-2">
            <Link href="/ufos/lekcje" className="btn-secondary justify-center text-xs py-4 flex-col gap-1.5 h-auto">
              <BookOpen className="w-4 h-4" />
              Lekcje
            </Link>
            <Link href="/ufos/lekcje/zaleglosci" className="btn-secondary justify-center text-xs py-4 flex-col gap-1.5 h-auto">
              <AlertTriangle className="w-4 h-4" />
              Zaległości
            </Link>
            <Link href="/ufos/lekcje/rentownosc" className="btn-secondary justify-center text-xs py-4 flex-col gap-1.5 h-auto">
