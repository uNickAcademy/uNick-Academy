...
export default async function CfoDashboardPage() {
  ...
  if (role !== "owner_cfo") redirect("/ufos/dashboard/ops")
      ...
      {!hasData ? (
        <div className="card">
          <div className="flex flex-col items-center py-10 text-center">
            ...
            <Link href="/ufos/lekcje" className="btn-secondary text-sm">Przejdź do lekcji</Link>
          </div>
        </div>
      ) : (
              ...
              {(debtors?.length ?? 0) > 0 && (
                <div className="card border-l-4 border-l-brand-red py-4">
                  <div className="flex items-start justify-between">
                    ...
                    <Link href="/ufos/lekcje/zaleglosci" className="text-xs text-navy-500 hover:underline shrink-0">
                      Szczegóły →
                    </Link>
                  </div>
                </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <section>
                <div className="flex items-center justify-between mb-3">
                  ...
                  <Link href="/ufos/lekcje/rentownosc" className="text-xs text-navy-500 hover:underline">
                    Wszyscy →
                  </Link>
                </div>
