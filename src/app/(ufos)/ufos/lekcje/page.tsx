...
import { formatDate, formatPLN, formatPercent } from "@/lib/ufos/formatters"
  ...
  return (
    <div className="max-w-5xl mx-auto">
      <div className="flex items-center justify-between mb-8">
        ...
        <Link href="/ufos/lekcje/rentownosc" className="btn-secondary text-sm">
      ...
      <div className="mt-4 flex items-center justify-between">
        <Link href="/ufos/lekcje/zaleglosci" className="text-sm text-brand-red hover:underline flex items-center gap-1">
