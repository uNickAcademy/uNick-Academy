...
import { formatDate } from "@/lib/ufos/formatters"
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="flex items-center justify-between mb-8">
        ...
        <Link href="/ufos/zadania/nowe" className="btn-primary text-sm">
                ...
                return (
                  <tr key={t.id} className="border-t border-[#E8EBF0] hover:bg-brand-muted/40">
                    <td className="py-3 px-6">
                      <Link href={`/ufos/zadania/${t.id}`} className="font-medium text-navy-500 hover:underline">
                        {t.title}
                      </Link>
                    </td>
