...
import { formatPLN, formatDateTime } from "@/lib/ufos/formatters"
      ...
      <div className="flex items-center justify-between mb-8">
        ...
        {hasAccounts && (
          <div className="flex items-center gap-2">
            <Link href="/ufos/platnosci/import" className="btn-secondary text-sm">
              <Upload className="w-4 h-4" /> Importuj wyciąg
            </Link>
            <Link href="/ufos/platnosci/konta/nowe" className="btn-secondary text-sm">
      ...
      {!hasAccounts ? (
        <div className="card text-center py-10">
          ...
          <div className="flex items-center justify-center gap-2">
            <Link href="/ufos/platnosci/konta/nowe" className="btn-primary text-sm">
              <Plus className="w-4 h-4" /> Dodaj konto
            </Link>
            <Link href="/ufos/ustawienia/bank" className="btn-secondary text-sm">
              Open Banking
            </Link>
          </div>
        </div>
